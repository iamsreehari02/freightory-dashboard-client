        ...
        <Card className="max-w-none">
            ...
            <CardContent className="space-y-3">
                ...
                {!loading && renewals.length === 0 && (
                    <p className="text-sm text-muted-foreground">No upcoming renewals this month.</p>
                )}
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="flex-1 flex flex-col gap-1">
                                    <span className="font-medium text-base capitalize">{branch.name}</span>
                                ...
                                <div className="flex flex-col gap-4 items-end">
                                    <span
                                        className={`text-xs w-max font-medium px-2 py-1 rounded-full text-white ${daysRemaining < 10 ? "bg-red-600" : "bg-gray-400"
                                            }`}
                                    >
                                        {daysRemaining} day{daysRemaining !== 1 ? "s" : ""}
                                    </span>
                                    <AppButton onClick={handlePaynow}>
                                        Renew Now
                                    </AppButton>
                                </div>
                            </div>
